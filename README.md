...
- Um assistente de IA da sua preferência
...
- Criar página web 
- Fazer deploy da página web estática com Agent Toolkit
- Configurar serviço de envio de emails com Agent Toolkit
- Criar lógica backend para envio de emails
- Fazer deploy do backend com Agent Toolkit
